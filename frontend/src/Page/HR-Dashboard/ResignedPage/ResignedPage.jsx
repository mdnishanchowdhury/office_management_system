...
const ResignedPage = () => {
    ...
    // Fetch all employees and filter resigned
    const fetchEmployees = () => {
        ...
        fetch("http://127.0.0.1:8000/api/employees/", {
            ...
            .then((res) => res.json())
            .then((data) => {
                const resigned = Array.isArray(data)
                    ? data.filter((emp) => emp.status === "resigned")
                    : [];
                setEmployees(resigned);
            })
                ...
                <table className="w-full border-collapse text-left">
                    <thead className="bg-gray-100">
                        <tr className="text-gray-700 font-semibold">
                            ...
                            <th className="px-4 py-3 border-b">Resigned</th>
